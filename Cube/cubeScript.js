...
function colorLeftCube(changer) {
    ...
    const changer1 = document.querySelector('.left');
    changer1.style.backgroundColor = `rgb(${red1}, ${green1}, ${blue1})`;
    const element4 = document.querySelector('.left');
        element4.style.display = 'flex';
    
}

function colorRightCube(changer) {

    const red2 = Math.floor(Math.random() * 256);
     const green2 = Math.floor(Math.random() * 256);
     const blue2 = Math.floor(Math.random() * 256);
    const changer2 = document.querySelector('.right');
    changer2.style.backgroundColor = `rgb(${red2}, ${green2}, ${blue2})`;
    const element5 = document.querySelector('.right');
